...
export function DocumentsLandingPage() {
  ...
  const features = [
    {
      ...
      description: 'Organisez tous vos documents de compliance dans une structure hiérarchique avec des dossiers et sous-dossiers intelligents.',
    ...
    },
    {
      ...
      description: 'Retrouvez instantanément n\'importe quel document grâce à la recherche multi-critères et au tagging automatique.',
    ...
    },
    {
      ...
      description: 'Piste d\'audit automatique de toutes les actions sur vos documents pour une conformité réglementaire totale.',
  ...
  const benefits = [
    ...
    'Export batch pour audits',
    'Intégration DocuSign native'
  ];
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              >
                ...
                <h1 className="text-5xl text-white mb-4">
                  Gestion documentaire <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">intelligente</span>
                </h1>
                <p className="text-xl text-white/80 mb-8 max-w-2xl">
                  Centralisez, organisez et sécurisez tous vos documents de compliance avec une solution de gestion documentaire complète et intelligente.
                </p>
            ...
            >
              <div className="w-96 h-96">
                <FolderOpen className="w-full h-full text-white/20" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        >
          ...
          <p className="text-lg text-gray-600">
            Une solution complète pour gérer vos documents de compliance
          </p>
        </motion.div>
        ...
        >
          ...
          <h3 className="text-3xl mb-4">Prêt à optimiser votre gestion documentaire ?</h3>
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
            Activez le module Compliance Plus pour accéder à la gestion documentaire et toutes les fonctionnalités avancées.
          </p>
          <Button 
            size="lg"
            onClick={() => navigate('/settings/app-store')}
