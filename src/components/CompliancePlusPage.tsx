...
import { KYCFilesPage } from './KYCFilesPage';
...
import { DocumentAnalysisIllustration } from './illustrations/DocumentAnalysisIllustration';
...
export function CompliancePlusPage({ onEnableModule }: CompliancePlusPageProps = {}) {
  ...
  const features = [
    {
      icon: Zap,
      title: 'Onboarding en marque blanche',
      description: 'Pré-remplissage automatique des formulaires pour réduire la friction et améliorer l\'expérience utilisateur.',
    ...
    },
    {
      ...
      description: 'Registres officiels, UBO, et autres sources pour des vérifications complètes et fiables.',
    ...
    },
    {
      ...
      description: 'Détection automatique d\'incohérences et extraction de données pour un gain de temps considérable.',
      gradient: 'from-purple-500 to-pink-500',
      delay: 0.3,
      illustration: DocumentAnalysisIllustration
    },
    {
      icon: TrendingUp,
      title: 'Scoring dynamique',
      description: 'Workflows de décision personnalisables avec différenciation des parcours selon le niveau de risque.',
    ...
    },
    {
      ...
      description: 'Surveillance continue des sanctions, PEP et adverse media pour une couverture réglementaire renforcée.',
    ...
    },
    {
      ...
      description: 'Portail client avec historique complet, notes internes et échanges fluides pour une meilleure productivité.',
  ...
  const benefits = [
    ...
    'Intégrations best-of-breed pré-négociées',
    'Mode Zero-Data-Retention disponible',
    'Traçabilité complète du raisonnement',
    'Des agents IA autonomes pour traiter et analyser vos dossiers en quelques secondes',
    'Moteur de risque personnalisable'
  ];
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Accédez à la prochaine génération de gestion de la compliance avec notre module avancé
            </p>
          </motion.div>
        </div>
      </div>
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                ...
                intelligent et ultra-rapide. Lancez-vous sur de nouveaux marchés en quelques secondes avec une 
                confiance réglementaire totale.
              </p>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button
                  ...
                  variant={onEnableModule ? "outline" : "default"}
                  style={!onEnableModule ? { background: 'linear-gradient(62.32deg, #000000 10.53%, #0F323D 88.82%)' } : undefined}
                  className={`gap-2 ${!onEnableModule ? 'hover:opacity-90 shadow-lg hover:shadow-xl text-white' : ''}`}
                >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-1">Traitement par lots</h4>
                <p className="text-sm text-gray-600">Automatisation massive des processus de compliance</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-1">Ciblage intelligent</h4>
                <p className="text-sm text-gray-600">Focus automatique sur les cas à risque élevé</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-[#0066FF] rounded-full mt-2 flex-shrink-0" />
              <div>
                <h4 className="font-semibold text-gray-900 mb-1">Communications automatisées</h4>
                <p className="text-sm text-gray-600">Notifications et relances intelligentes</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-[#7C3AED] rounded-full mt-2 flex-shrink-0" />
              <div>
                <h4 className="font-semibold text-gray-900 mb-1">Chat with your data</h4>
                <p className="text-sm text-gray-600">Interrogation en langage naturel de vos données de compliance</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="inline-flex flex-col items-center gap-4 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 shadow-2xl">
            ...
            <p className="text-white text-lg max-w-md">
              Prêt à révolutionner votre gestion de la compliance ?
            </p>
            <Button
              onClick={() => {
                toast.success('Demande envoyée !', {
