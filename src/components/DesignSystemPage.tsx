...
const investorListingColumnSpecs = [
  ...
  {
    column: 'NB RÉOUVERTURES',
    component: 'reopen-count-badge',
    functional: 'Afficher le nombre de réouvertures onboarding en badge count.',
    guidelines: 'Badge rond écru (#F8F7F1) avec bordure écru foncé (#D9D8CB) et texte bleu financier.',
    variants: '0 (texte neutre), 1, n réouvertures.',
  },
  {
    column: 'DATES OPÉRATIONNELLES',
    component: 'date-time',
    functional: 'Uniformiser Envoi à signature / Dernière relance / Création / MAJ / Activation.',
    guidelines: 'Composant unique DateTime en variante écru, icon calendrier, date relative + absolue.',
    variants: 'Date présente, date absente.',
  },
  {
    column: 'DERNIÈRE ACTION',
    component: 'duration',
    functional: 'Afficher strictement la durée écoulée pour la dernière action.',
    guidelines: 'Pill compacte avec icône timer et libellé relatif.',
    variants: 'minutes, heures, jours, semaines, mois.',
  },
  {
    column: 'MONTANT APPELÉ',
    component: 'called-amounts',
    functional: 'Visualiser appelé / en attente / restant avec les couleurs DS.',
    guidelines: 'Barre segmentée: vert croissance, orange warning, bleu financier.',
    variants: '0 €, partiel, appelé majoritaire.',
  },
  {
    column: 'NOTES',
    component: 'notes',
    functional: 'Ouvrir le détail des notes (contenu, date, auteur) depuis la cellule.',
    guidelines: 'Dernière note tronquée + badge count cliquable ouvrant un dialogue.',
    variants: 'Aucune note, 1 note, plusieurs notes.',
  },
  {
