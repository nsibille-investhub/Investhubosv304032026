              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <div className="inline-flex items-center gap-3 pl-3 pr-4 py-2.5 bg-gradient-to-r from-gray-50 to-gray-50/50 hover:from-blue-50/50 hover:to-indigo-50/30 rounded-xl border border-gray-200 hover:border-blue-200 transition-all duration-300 cursor-pointer shadow-sm hover:shadow-md">
                          ...
                          <div className="flex flex-col gap-1.5 min-w-[140px]">
                            <div className="flex items-center gap-1.5">
                              <span className="text-[10px] font-semibold text-blue-600 uppercase tracking-wider">Signature</span>
                              <div className="w-0.5 h-0.5 bg-gray-300 rounded-full" />
                              <span className="text-[10px] font-medium text-gray-500">84 actives</span>
                            </div>
                            
                            {/* Usage stats */}
                            <div className="flex flex-col gap-1">
                              <div className="flex items-baseline gap-1">
                                <span className="text-base font-bold text-blue-600 leading-none">84</span>
                                <span className="text-xs text-gray-400 font-medium">/</span>
                                <span className="text-sm font-semibold text-gray-600 leading-none">200</span>
                              </div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] font-medium text-gray-500 tabular-nums">42% utilisé</span>
                              </div>
                            </div>
                          </div>
                      ...
                      <TooltipContent side="bottom" className="max-w-xs">
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-semibold text-white">Yousign Active</span>
                          </div>
                          <div className="text-xs text-gray-300 space-y-1">
                            <p>✓ Electronic signature integration</p>
                            <p>✓ 247 / 2000 signatures (12% usage)</p>
                            <p>✓ Real-time tracking</p>
                            <p>✓ Secure & compliant</p>
                          </div>
                          <div className="pt-2 border-t border-gray-700">
                            <div className="flex items-center justify-between text-xs">
                              <span className="text-gray-400">Quota restant</span>
                              <span className="text-white font-semibold">1,753 signatures</span>
                            </div>
                          </div>
                          <div className="pt-1 border-t border-gray-700 text-[10px] text-gray-400">
                            Last signature: 1 hour ago
                          </div>
                        </div>
                        </TooltipContent>
                      </Tooltip>
